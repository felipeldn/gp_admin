...
ActiveRecord::Schema.define(version: 2021_06_09_224448) do
  ...
  create_table "flights_climbeds", force: :cascade do |t|
    t.integer "value"
    t.datetime "date_time"
    t.integer "patient_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["patient_id"], name: "index_flights_climbeds_on_patient_id"
  end
  ...
  add_foreign_key "flights_climbeds", "patients"
